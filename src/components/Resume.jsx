      ...
      <div className="container">
		...
		<div className="row align-items-center my-5">
        	<div className="col-lg-9">
					...
					Worked with HTML, CSS, JavaScript, JQuery, PHP, and Perl to make updates to the functionality of the company's Magento based website. This included creating extensions too magento plugins. Also handled general hardware related IT duties. <br/> <br/> 
					<h5>Front End Web Developer – Starling Eyewear  - October 2015 - March 2016</h5>
					Used HTML, CSS (responsive), and PHP to make updates to the functionality of the company’s Magento based e-commerce website. Worked closely with the graphics team to execute vision for a responsively designed site. <br/><br/> 
					...
					Utilized SQL, stored procedures, HTML, CSS, and JavaScript to create fantasy sports websites based on client specifications. Also created an internal wiki site and handled on-call duties. <br/><br/> 
					<h5>Systems Analyst – Donlen Corporation  -  May 2006 – September 2007</h5>
					Utilized Java, XML, and SQL to fix bugs, add new functionality, and make improvements to web based software used by internal and external clients to manage their leased vehicles.<br/><br/> 
